#!/usr/bin/env python3
"""
Test Theodore's fixed configuration
"""
...
async def test_fixed_config():
    """Test Theodore's fixed configuration"""
    print("="*60)
    print("TESTING THEODORE'S FIXED CONFIGURATION")
    print("="*60)
    ...
    async with AsyncWebCrawler(
        ...
        # Theodore's FIXED enhanced configuration
        config = CrawlerRunConfig(
            ...
            wait_for="css:main",  # FIXED: No comma syntax
        ...
        print(f"🚀 Testing FIXED configuration with {len(TEST_URLS)} URLs...")
        ...
        if len(successful_extractions) == len(TEST_URLS):
            ...
            print(f"   Theodore's scraper should now work for CloudGeometry!")
        else:
            print(f"\n⚠️  Some pages still failing - need further investigation")
