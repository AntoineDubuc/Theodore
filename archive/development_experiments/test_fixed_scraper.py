#!/usr/bin/env python3
"""
Test the fixed Crawl4AI scraper with resolved LLMConfig ForwardRef issue
"""
...
async def test_fixed_scraper():
    """Test the fixed scraper with Visterra"""
    ...
    try:
        logger.info("Testing fixed Crawl4AI scraper...")
        ...
        if result.scrape_status == "success":
            logger.info("✅ SUCCESS: Fixed scraper is working with LLMExtractionStrategy!")
        else:
